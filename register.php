<?php
session_start();
require_once "./auth/validate-login.php";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="./auth/process-register.php">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" name="password_confirm" />
